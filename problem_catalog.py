...
PROBLEM_CATALOGUES = [
    ...
    [
        ...
        {
            "id": "L1_P009",
            "beskrivning": "Jag har fått ett viktigt brev från Försäkringskassan som en fil på datorn. När jag försöker öppna den är hela sidan kritvit. Jag ser inga siffror alls. Ibland kommer det upp ett litet felmeddelande om en 'ogiltig färgrymd'. Måns tycker också det ser konstigt ut.",
            "tekniska_fakta": {
        ...
        {
            "id": "L1_P010",
            "beskrivning": "Jag skulle logga in på banken med min gamla webbläsare, men det kom upp en stor röd varningssida om att anslutningen inte är säker. Uppe i adressfältet är det ett litet hänglås som är överstruket. Jag blir så nervös av sånt!",
            "tekniska_fakta": {
                "bank": "Swedbank",
    ...
    [
        ...
        {
            "id": "L2_P006",
            "beskrivning": "Jag pratar med barnbarnen i ett videoprogram, men funktionen fungerar bra i vardagsrummet där internetlådan står, men om jag går in i sovrummet blir WiFi-signalen jättesvag. Samtalet börjar hacka och säger att anslutningen är svag, sen bryts det. Det är en tjock vägg emellan.",
            "tekniska_fakta": {
        ...
        {
            "id": "L2_P007",
            "beskrivning": "Min skrivare har en stadig grön lampa, men inne i datorn är ikonen för den alldeles grå och det står 'Frånkopplad'. När jag försöker skriva ut fastnar jobbet bara i kön med ett fel. Det är som att de inte pratar med varandra längre! Jag har provat att dra ur sladden och byta port.",
            "tekniska_fakta": {
        ...
        {
            "id": "L2_P009",
            "beskrivning": "Jag lyssnade på musik i mina hörlurar, men ljudet fortsatte att komma ur de stora högtalarna i datorskärmen! Jag tittade i ljudinställningarna och där är högtalarna valda som standard. Mina hörlurar finns i listan men är inte valda. Det är ju inte klokt!",
            "tekniska_fakta": {
    ...
    [
        ...
        {
            "id": "L3_P006",
            "beskrivning": "Jag pratar med barnbarnen i Skype, men de klagar på att de hör sin egen röst som ett eko från min dator. Jag använder den inbyggda mikrofonen och högtalarna, inget headset. Jag ser att mikrofonsymbolen reagerar även när bara de pratar. Det låter som vi är i en kyrka!",
            "tekniska_fakta": {
        ...
        {
            "id": "L3_P010",
            "beskrivning": "Jag ska logga in på banken med SMS-kod säger den att koden är ogiltig eller för gammal. Jag tittade på klockan på min telefon och den visade en tid, men datorns klocka visade en tid som var tre minuter tidigare! Jag ser att automatisk tid är avstängd i telefonen.",
            "tekniska_fakta": {
                "bank": "Handelsbanken",
    ...
    [
        {
            "id": "L4_P001",
            "beskrivning": "Direkt när jag tryckte på startknappen på min dator började den bara pipa tre gånger, kort och ilsket. Strömlampan lyser grönt, men skärmen är helt svart. Min son sa att tre pip ofta betyder problem med minnet på den här typen av datorer.",
            "tekniska_fakta": {
        ...
        {
            "id": "L4_P003",
            "beskrivning": "Jag har anslutit min bärbara dator till mitt trådlösa nätverk, men istället för WiFi-symbolen visas en liten flygplansikon. I inställningarna står det 'Flygplansläge: På'. Jag har provat att trycka Fn+F3, där det är en flygplanssymbol, men inget händer.",
            "tekniska_fakta": {
        ...
        {
            "id": "L4_P010",
            "beskrivning": "Min iPad har börjat tjata om att lagringsutrymmet är nästan fullt. I inställningarna ser jag att en stor del upptas av 'Nyligen raderade' bilder, trots att jag har raderat massor från Bilder-appen. I albumet 'Nyligen raderade' ligger alla bilderna kvar.",
            "tekniska_fakta": {
    ...
    [
        ...
        },
        {
            ...
            "tekniska_fakta": {
                ...
                "felkod": "Certifikatfel 'DLG_FLAGS_INVALID_CA / INET_E_SECURITY_PROBLEM'",
        ...
        {
            "id": "L5_P007",
            "beskrivning": "När jag har många flikar öppna i webbläsaren och samtidigt redigerar bilder, kommer det ofta upp ett meddelande från Windows om att datorn har ont om minne. Ofta kraschar programmen strax efteråt. Jag ser att växlingsfilen är ganska liten.",
            "tekniska_fakta": {
